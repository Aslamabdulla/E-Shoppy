...
class LightThemeColors {
  ...
  //login gradient
  static const Color gradientLogin = Color(0xff00BFA5);
  static const Color gradientLogin2 = Color(0xff64FFDA);

  //common
  static Color get kWhiteBg => Color.fromRGBO(234, 233, 233, 1);
}
